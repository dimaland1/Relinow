...
ReliNow turns a raw, fast but unreliable radio link (ESP-NOW) into a lightweight embedded networking protocol that adds acknowledgments, ordering, retransmission, logical channels, and fragmentation, with three delivery modes tailored to real-time needs.
